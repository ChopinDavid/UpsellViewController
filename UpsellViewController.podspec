#
#  Be sure to run `pod spec lint UpsellViewController.podspec' to ensure this is a
...
Customizable view controller for promoting your app's products to users.
  ...
  # Or just: spec.author    = "David Chopin"
  # spec.authors            = { "David Chopin" => "dchopin1@live.maryville.edu" }
  # spec.social_media_url   = "https://twitter.com/David Chopin"
  ...
  spec.source       = { :git => "https://github.com/ChopinDavid/UpsellViewController.git", :tag => "#{spec.version}" }
